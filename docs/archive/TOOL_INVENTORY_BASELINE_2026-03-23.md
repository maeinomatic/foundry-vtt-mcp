...
This file is the preserved baseline snapshot of the tool inventory as it stood
on 2026-03-23, immediately before the live inventory was split into:

- [MCP_TOOL_CATALOG.md](../process/MCP_TOOL_CATALOG.md)
- [WORKFLOW_ROADMAP.md](../process/WORKFLOW_ROADMAP.md)

Treat this file as a point-in-time reference, not the active roadmap.
